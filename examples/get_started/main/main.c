 ...
 *
 * Minimal sanity-check app for esp_srtp2: initializes and shuts down libsrtp.
...
static const char *TAG = "esp_srtp2_check";
...
void app_main(void)
{
    ...
    srtp_shutdown();
    ESP_LOGI(TAG, "esp_srtp2 build check complete");
}
